...
echo 18) Stats 
echo kienboec
curl -X GET http://localhost:10001/stats?format=plain --header "Authorization: Basic kienboec-mtcgToken"
echo.
echo altenhof
...
curl -X GET http://localhost:10001/tradings  --header "Authorization: Basic kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/tradings?format=plain  --header "Authorization: Basic altenhof-mtcgToken"
echo.
...
echo.
curl -X POST http://localhost:10001/friends --header "Content-Type: application/json" --header "Authorization: Basic kienboec-mtcgToken" -d "\"altenhof\""
echo.
curl -X GET http://localhost:10001/friends --header "Authorization: Basic kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/friends?format=plain --header "Authorization: Basic altenhof-mtcgToken"
echo.
curl -X DELETE http://localhost:10001/friends --header "Authorization: Basic altenhof-mtcgToken" -d "\"kienboec\""
echo.
curl -X GET http://localhost:10001/friends --header "Authorization: Basic kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/friends --header "Authorization: Basic altenhof-mtcgToken"
...
curl -X POST http://localhost:10001/friends --header "Content-Type: application/json" --header "Authorization: Basic kienboec-mtcgToken" -d "\"altenhof\""
echo.
curl -X POST http://localhost:10001/friends --header "Content-Type: application/json" --header "Authorization: Basic altenhof-mtcgToken" -d "\"altenhof\""
echo.
curl -X GET http://localhost:10001/friends --header "Authorization: Basic kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/friends --header "Authorization: Basic altenhof-mtcgToken"
